  ...
  return (
    <div className=" bg-white w-full flex items-center justify-center" style={{ height: 'calc(100vh - 136px)'}}>
      <div className="items-center justify-center p-8 text-center">
        <h1 className="tracking-tight font-instrument text-8xl text-[#7B7B7B]">An easier way to</h1>
        <h1 className="tracking-tight font-instrument text-8xl mb-4">send emails later.</h1>
