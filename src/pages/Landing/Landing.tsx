...
function Feature({ icon: Icon, heading, text }: {icon: LucideIcon, heading: string, text: string}) {
 return (
   <div className="border-[0.5px] border-gray-300 rounded-2xl w-80 h-60 p-6 flex flex-col items-center text-center">
    ...
    <div className="bg-white w-full flex flex-col">
      <div className="flex justify-center">
        <div className="flex flex-col items-center p-8 text-center w-4/5">
          ...
          <div className="flex flex-col items-center rounded-lg bg-[#ebfaff] p-6 w-full">
